      ...
      <form @submit.prevent="submit" class="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-6">
        ...
        <div class="mb-6">
          <div class="flex justify-between items-center mb-2">
            ...
            <button
              type="button"
              @click="clearJsonContent"
              class="bg-gray-400 hover:bg-gray-500 text-white px-3 py-1 rounded text-xs"
            >
              Clear
            </button>
          </div>
          <textarea
            ...
            class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline font-mono text-sm"
            rows="20"
        ...
        <div class="flex items-center justify-between">
          <button
            ...
            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded focus:outline-none focus:shadow-outline disabled:opacity-50"
          >
